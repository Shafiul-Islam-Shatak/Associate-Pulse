...
const Footer = () => {
    return (
        <footer className="px-4 divide-y bg-gray-700 text-white">
                ...
                <div className="lg:w-1/3">
                    <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                        <div className="flex items-center justify-center rounded-full dark:bg-violet-600">
                           <img src="https://i.ibb.co/d754Kxj/whitw-Blue-and-Black-Modern-Digital-Technology-Logo.png" />
                        </div>
            ...
            <div className="py-6 text-sm text-center dark:text-gray-600">All rights reserved to Associate Pulse</div>
        </footer>
    );
};
