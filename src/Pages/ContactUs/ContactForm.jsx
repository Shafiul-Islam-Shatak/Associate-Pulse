...
const ContactForm = () => {
    ...
    return (
        <div className="my-10 lg:my-20 animate__animated animate__bounce animate__delay-2s">
            ...
            <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-2xl shadow-gray-500  lg:max-w-4xl">
                <div
                ...
                <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
                    ...
                    <form onSubmit={hanldeContactSubmit}>
                        ...
                        <div className="mt-4">
                            ...
                            <textarea name="message" placeholder="Please type your query or message" className="block w-full px-4 py-2 text-gray-700 bg-white border rounded-lg  focus:border-blue-400 focus:ring-opacity-40  focus:outline-none focus:ring focus:ring-blue-300 textarea textarea-bordered textarea-lg " ></textarea>
                        </div>
